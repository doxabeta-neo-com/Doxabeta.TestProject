    ...
    public class Course : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View CourseE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CourseE", typeof(IIS.Test_Project.Course));
                }
            }
            ...
            public static ICSSoft.STORMNET.View CourseL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("CourseL", typeof(IIS.Test_Project.Course));
                }
            }
        }
    }
